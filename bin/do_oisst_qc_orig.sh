...
# Output file
sst_spear=sst_oidaily_icecorr_icec25_${last_year}01_${last_yearmon}_workaround.nc
...
REGRID_OUT=sst.day.${last_year}01_${last_yearmon}.1x1_workaround.nc
...
restoring_sst=sst_oidaily_icecorr_icec30_fill_${last_year}01_${last_yearmon}_workaround.nc
